...
ClientCredentialsGrantType.prototype.handle = function(request, client) {
  ...
  return Promise.bind(this)
    .then(function() {
      return this.getUserFromClient(client); /**match client_key:client_creditials pair */
    })
    .then(function(user) {
      return this.saveToken(user, client, scope); /** send generated access_token in hashed (need to map into a memory object) or encrypted format */
    });
};
