...
/**
 * Token Handler.. to be referenced in oAuth Server's /token endpoint
 */
...
TokenHandler.prototype.handle = function(request, response) {
  ...
  return Promise.bind(this)
    ...
    .then(function(client) {
      //depending on grant_type, generate an token model; see grant-types/password-grant-type
      //must return an object containing {access_token, expirtyInfo, userClaims}
    ...
    .tap(function(data) {
      ...
      //*********************bchen*************************** */
      // write tokenType.valueOf() into response
